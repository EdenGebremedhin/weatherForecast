...
//         var cityData = JSON.parse($(this).val());

//         // Clear previous results
//         $('#results').empty();

//         // Display loading message
//         $('#get-results-heading').text('Fetching weather data...');
...
//                 // Process the data and display weather forecast
//                 displayWeatherForecast(data);
//             },
//             error: function(err) {
//                 // Handle errors
//                 console.error('Error fetching weather data:', err);
//                 $('#get-results-heading').text('Failed to fetch weather data');
//             }
//         });
//     });
...
//         $('#get-results-heading').empty();

//         // Display city name
//         $('#results').append('<h2>' + cityName + '</h2>');

//         // Display each forecast entry
//         forecastList.forEach(function(entry) {
//             var dateTime = new Date(entry.dt * 1000 + timezone * 1000).toLocaleString();
//             var temperature = entry.main.temp;
//             var weatherDescription = entry.weather[0].description;

//             var forecastHTML = '<p><strong>' + dateTime + '</strong>: ' + temperature + '°C, ' + weatherDescription + '</p>';
//             $('#results').append(forecastHTML);
//         });
//     }
